/*
 * Mar 22, 2024
 * Made changes from Antony Shim's file and added functions from Tom's task and Leo's task
*/
    ...
    public static void main(String []args) throws Exception {
        ...
        try {
            ...
            for (int i = 1; i <= 12; i++) {
                ...
                myClub.getCoach().setMonthlySalary(i, Integer.parseInt(coach_inattendance[3]));
            }
            coach_br.close();
        }   
        catch (IOException e) {
        ...
        new ClubGUI(myClub);
        for(int i = 0; i< myClub.getCoach().getMonthlySalary().length; i++){
            System.out.println(myClub.getCoach().getMonthlySalary()[i]);
        }
        System.out.println("\nReminders:");
        //myClub.updateMemberList();
        myClub.showMembers();
        //myClub.getMemberList();
        /*
        myClub.sortbByTimesPaid();
        System.out.println("\nSorted by times paid:");
        myClub.getMemberList();
        ...
        */
        int test_month = 4;
        int test_var_cost = 0;
        System.out.println(myClub.getCoach().getUnpaidSalary());
